...
Widget buildAssetAllocationChart(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          _buildSectionHeader(context, "Asset Allocation"),
          SizedBox(height: 20),
          Row(
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    _buildAllocationLegend("Stocks", "55%", Colors.blue),
                    const SizedBox(height: 12),
                    _buildAllocationLegend("Crypto", "20%", Colors.green),
                    const SizedBox(height: 12),
                    _buildAllocationLegend("Bonds", "15%", Colors.purple),
                    const SizedBox(height: 12),
                    _buildAllocationLegend("Cash", "10%", Colors.grey),
                  ],
                ),
              ),
            ],
  ...
  Widget _buildSectionHeader(BuildContext context, String title) {
    return Row(
      ...
      children: [
        ...
        Text(
          title == "Current Holdings" ? "See All" : "...",
          style: const TextStyle(
